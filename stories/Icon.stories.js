...
export default {
  title: "Atoms_And_Molecules/Icon",
  component: Icon,
  tags: ["autodocs"],
  argTypes: {
    icon: {
  ...
  args: {
    icon: `<img src="https://develop.aladia.io/favicon.ico">`,
    size: 16,
    color: "black",
  },
};
...
export const SVG = {
  args: {
    icon: `<svg class="ml-20" width="20px" height="20px" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" version="1.1" id="svg9" viewBox="0 0 666.66668 666.66717">
            <defs id="defs13">
